...
public class InfoCenter {
    ...
    public InfoCenter() {
        ...
        instructions = new Label("Select a Color you Want to Move");
        instructions.setMinSize(UIConstants.APP_WIDTH, UIConstants.INFO_CENTER_HEIGHT);
        ...
        playerPoints.setMinSize(UIConstants.APP_WIDTH, UIConstants.INFO_CENTER_HEIGHT);
        ...
        checkPatternButton = new Button("I Have a Pattern !");
